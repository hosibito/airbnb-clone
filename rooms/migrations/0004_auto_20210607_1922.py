# Generated by Django 2.2.5 on 2021-06-07 10:22
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='facility',
            options={'verbose_name': '시설', 'verbose_name_plural': '시설들'},
        ),
        migrations.AlterModelOptions(
            name='houserule',
        ...
        migrations.AlterModelOptions(
            name='roomtype',
            options={'ordering': ['name', 'create'], 'verbose_name': 'Room Type'},
        ),
